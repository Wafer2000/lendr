...
class CollectorsLoanBimonthly extends StatefulWidget {
  static const String routname = '/collectors_loan_bimonthly';
  const CollectorsLoanBimonthly({super.key});

  @override
  State<CollectorsLoanBimonthly> createState() => _CollectorsLoanBimonthlyState();
}

class _CollectorsLoanBimonthlyState extends State<CollectorsLoanBimonthly> {
