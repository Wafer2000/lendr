...
class CollectorsLoanWeekly extends StatefulWidget {
  static const String routname = '/collectors_loan_weekly';
  const CollectorsLoanWeekly({super.key});

  @override
  State<CollectorsLoanWeekly> createState() => _CollectorsLoanWeeklyState();
}

class _CollectorsLoanWeeklyState extends State<CollectorsLoanWeekly> {
