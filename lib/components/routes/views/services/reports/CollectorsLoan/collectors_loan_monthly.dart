...
class CollectorsLoanMonthly extends StatefulWidget {
  static const String routname = '/collectors_loan_monthly';
  const CollectorsLoanMonthly({super.key});

  @override
  State<CollectorsLoanMonthly> createState() => _CollectorsLoanMonthlyState();
}

class _CollectorsLoanMonthlyState extends State<CollectorsLoanMonthly> {
