...
class CollectorsLoanQuarterly extends StatefulWidget {
  static const String routname = '/collectors_loan_quarterly';
  const CollectorsLoanQuarterly({super.key});

  @override
  State<CollectorsLoanQuarterly> createState() => _CollectorsLoanQuarterlyState();
}

class _CollectorsLoanQuarterlyState extends State<CollectorsLoanQuarterly> {
