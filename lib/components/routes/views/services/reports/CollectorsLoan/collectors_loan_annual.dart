...
class CollectorsLoanAnnual extends StatefulWidget {
  static const String routname = '/collectors_loan_annual';
  const CollectorsLoanAnnual({super.key});

  @override
  State<CollectorsLoanAnnual> createState() => _CollectorsLoanAnnualState();
}

class _CollectorsLoanAnnualState extends State<CollectorsLoanAnnual> {
