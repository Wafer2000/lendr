...
class CollectorsLoanSemiannual extends StatefulWidget {
  static const String routname = '/collectors_loan_semiannual';
  const CollectorsLoanSemiannual({super.key});

  @override
  State<CollectorsLoanSemiannual> createState() => _CollectorsLoanSemiannualState();
}

class _CollectorsLoanSemiannualState extends State<CollectorsLoanSemiannual> {
