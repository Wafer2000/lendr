...
class AmountDebtSemiannual extends StatefulWidget {
  static const String routname = '/amount_debt_semiannual';
  const AmountDebtSemiannual({super.key});

  @override
  State<AmountDebtSemiannual> createState() => _AmountDebtSemiannualState();
}

class _AmountDebtSemiannualState extends State<AmountDebtSemiannual> {
