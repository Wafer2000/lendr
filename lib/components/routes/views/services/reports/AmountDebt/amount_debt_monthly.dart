...
class AmountDebtMonthly extends StatefulWidget {
  static const String routname = '/amount_debt_monthly';
  const AmountDebtMonthly({super.key});

  @override
  State<AmountDebtMonthly> createState() => _AmountDebtMonthlyState();
}

class _AmountDebtMonthlyState extends State<AmountDebtMonthly> {
