...
class AmountDebtAnnual extends StatefulWidget {
  static const String routname = '/amount_debt_annual';
  const AmountDebtAnnual({super.key});

  @override
  State<AmountDebtAnnual> createState() => _AmountDebtAnnualState();
}

class _AmountDebtAnnualState extends State<AmountDebtAnnual> {
