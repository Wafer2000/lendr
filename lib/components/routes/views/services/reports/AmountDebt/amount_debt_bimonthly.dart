...
class AmountDebtBimonthly extends StatefulWidget {
  static const String routname = '/amount_debt_bimonthly';
  const AmountDebtBimonthly({super.key});

  @override
  State<AmountDebtBimonthly> createState() => _AmountDebtBimonthlyState();
}

class _AmountDebtBimonthlyState extends State<AmountDebtBimonthly> {
