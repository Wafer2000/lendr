...
class AmountDebtQuarterly extends StatefulWidget {
  static const String routname = '/amount_debt_quarterly';
  const AmountDebtQuarterly({super.key});

  @override
  State<AmountDebtQuarterly> createState() => _AmountDebtQuarterlyState();
}

class _AmountDebtQuarterlyState extends State<AmountDebtQuarterly> {
