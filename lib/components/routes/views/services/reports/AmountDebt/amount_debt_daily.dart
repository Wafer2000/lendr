...
class AmountDebtDaily extends StatefulWidget {
  static const String routname = '/amount_debt_daily';
  const AmountDebtDaily({super.key});

  @override
  State<AmountDebtDaily> createState() => _AmountDebtDailyState();
}

class _AmountDebtDailyState extends State<AmountDebtDaily> {
