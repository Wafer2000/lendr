...
class LatePayments extends StatefulWidget {
  static const String routname = '/late_payments';
  const LatePayments({super.key});

  @override
  State<LatePayments> createState() => _LatePaymentsState();
}

class _LatePaymentsState extends State<LatePayments> {
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () async {
                      ...
                      final int loanAmount = int.parse(data['loanAmount']) -
                      ...
                      if (generalSnapshot.exists) {
                        ...
                        if (clientSnapshot.exists) {
                          ...
                          final int collect = int.parse(cli['collect']) -
                              int.parse(paymentCreditController.text);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          elevation: 0,
          title: const Center(child: Text('C o b r o s  A t r a s a d o s')),
          actions: [
            IconButton(
                  ...
                  return Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        String fpago = data['proxPay'];

                        DateTime fechaHoyDt = DateTime.parse(fhoy);
                        DateTime otraFechaDt = DateTime.parse(fpago);

                        bool isFechaHoyMayor = fechaHoyDt.isAfter(otraFechaDt);
